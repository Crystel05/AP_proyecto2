...
public class MenuDocente extends AppLayout {
    ...
    private List<RouterLink> createLinks() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Chat", "la la-comments", ListaCursosAsignar.class),
                new MenuItemInfo("Ver estudiantes", "la la-users", ListaCursosAsignar.class)
        };
